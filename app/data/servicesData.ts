...
export const servicesData: Record<string, Service> = {
  ...
  "anti-bird-nets": {
    ...
    description:
      "Servani Safety Nets offers anti bird nets that protect open areas from birds like pigeons, sparrows, and crows. These nets act as a safe and simple barrier to avoid nesting, dirt, and disturbance. They blend with the building design and are made from strong UV resistant material.",
    detailedContent: `
  ...
  "bird-nets-for-balconies": {
    ...
    description:
      "Balcony bird nets from Servani Safety Nets help keep unwanted birds away while allowing fresh air and clear visibility. These nets make balconies safer for families and prevent dirt caused by pigeons.",
    detailedContent: `
  ...
  "bird-netting-service": {
    ...
    description:
      "Servani Safety Nets provides complete bird netting services for homes and commercial buildings. These nets help prevent birds from nesting and causing hygiene problems in balconies and open areas.",
    detailedContent: `
  ...
  "bird-protection-nets": {
    ...
    description:
      "Bird protection nets from Servani Safety Nets stop birds from entering balconies, terraces, and open structures. They are safe, long lasting, and keep your surroundings hygienic.",
    detailedContent: `
  ...
  "pigeon-nets-installation": {
    ...
    description:
      "Servani Safety Nets offers professional pigeon net installation for balconies, windows, and open spaces. These nets help prevent pigeon entry and avoid stains, smell, and other hygiene problems.",
    detailedContent: `
  ...
  "pigeon-bird-spikes": {
    ...
    description:
      "Bird spikes from Servani Safety Nets prevent birds from sitting on ledges, rooftops, and AC units. These spikes work as a harmless way to stop birds from perching and creating mess.",
    detailedContent: `
  ...
  "building-safety-nets": {
    ...
    description:
      "Servani Safety Nets provides building safety nets to protect workers and nearby areas from falling objects during construction or maintenance. These nets ensure safety and reduce accident risks.",
    detailedContent: `
  ...
  "children-safety-nets": {
    ...
    description:
      "Children safety nets from Servani Safety Nets protect kids from accidental falls in balconies, windows, and terraces. These nets are safe, tough, and suitable for families in high rise homes.",
    detailedContent: `
  ...
  "construction-safety-nets": {
    ...
    description:
      "Servani Safety Nets provides construction safety nets to prevent accidents in building sites. These nets catch falling objects and reduce safety risks for workers and pedestrians.",
    detailedContent: `
  ...
  "industrial-safety-nets": {
    ...
    description:
      "Industrial safety nets from Servani Safety Nets are used to protect workers, equipment, and goods in factories and warehouses. These nets offer strong and reliable safety coverage.",
    detailedContent: `
  ...
  "pets-safety-nets": {
    ...
    description:
      "Pets safety nets by Servani Safety Nets help keep cats and dogs safe in balconies and windows by preventing accidental falls. These nets are transparent, strong, and secure.",
    detailedContent: `
  ...
  "swimming-pool-safety-nets": {
    ...
    description:
      "Swimming pool safety nets from Servani Safety Nets provide safety around pool areas by preventing accidental falls. These nets are suitable for homes, hotels, and resorts.",
    detailedContent: `
  ...
  "duct-area-safety-nets": {
    ...
    description:
      "Servani Safety Nets offers duct area safety nets to prevent falls and protect workers in open duct spaces. These nets are strong and secure for all building types.",
    detailedContent: `
  ...
  "open-area-safety-nets": {
    ...
    description:
      "Open area safety nets from Servani Safety Nets secure large open spaces such as shafts and courtyards. They prevent accidents and falling objects while maintaining airflow.",
    detailedContent: `
  ...
  "mosquito-safety-nets": {
    ...
    description:
      "Mosquito safety nets from Servani Safety Nets keep mosquitoes and insects out while allowing free airflow. Installed on windows, doors, or beds, they help maintain a healthy living environment.",
    detailedContent: `
  ...
  "monkey-safety-nets": {
    ...
    description:
      "Monkey safety nets from Servani Safety Nets prevent monkeys from entering balconies, rooftops, and open spaces. These nets avoid damage and maintain safety without harming animals.",
    detailedContent: `
  ...
  "shade-nets": {
    ...
    title: "Shade Nets",
    description:
      "Shade nets from Servani Safety Nets reduce heat, sunlight, and temperature in outdoor spaces. They help protect plants and provide comfort in gardens and terraces.",
    detailedContent: `
  ...
  "nylon-nets": {
    ...
    title: "Nylon Nets",
    description:
      "Nylon nets from Servani Safety Nets are strong, flexible, and suitable for multiple safety and sports uses. They perform well in both indoor and outdoor conditions.",
    detailedContent: `
  ...
  "anti-seagull-safety-nets": {
    ...
    description:
      "Anti seagull nets from Servani Safety Nets protect rooftops and balconies in coastal areas from seagulls. These nets stop nesting and reduce cleaning issues.",
    detailedContent: `
  ...
  "glass-safety-nets": {
    ...
    description:
      "Glass safety nets from Servani Safety Nets protect glass panels, balconies, and windows from accidents. These nets are transparent, strong, and blend with modern designs.",
    detailedContent: `
  ...
  "hdpe-safety-nets": {
    ...
    title: "HDPE Nets",
    description:
      "HDPE nets from Servani Safety Nets are lightweight, flexible, and resistant to chemicals and weather. They are used in construction, agriculture, and safety applications.",
    detailedContent: `
  ...
  "window-safety-nets": {
    ...
    description:
      "Window safety nets from Servani Safety Nets protect children and pets from falling while allowing fresh air and light. These nets are transparent, sturdy, and perfect for high rise apartments.",
    detailedContent: `
